...
export const contactPageContent = {
  ...
  am: {
    hero: {
      ...
      description: "የECAA አድራሻ መረጃን፣ የአካባቢ ዝርዝሮችን፣ የቢሮ መረጃን እና ቡድኑን ለማግኘት መንገዶችን ያግኙ።",
      buttons: [
...
export function getContactPageContent(language = "en") {
  ...
  return {
    ...
    contactInfo: {
      ...
      secondaryPhone: mergeLocalizedContent(
        en.contactInfo.secondaryPhone,
        am.contactInfo?.secondaryPhone
      ),
      ...
      mailingAddress: mergeLocalizedContent(
        en.contactInfo.mailingAddress,
        am.contactInfo?.mailingAddress
      ),
    },
