...
export const leadershipPageContent = {
  en: {
    hero: {
      ...
      buttons: [
        { label: 'View Committees', href: '#leadership-committees', style: 'primary' },
  ...
  am: {
    hero: {
      ...
      buttons: [
        { label: 'ኮሚቴዎችን ይመልከቱ', href: '#leadership-committees', style: 'primary' },
    ...
    explorer: {
      ...
      description:
        'የእነሱን ሚና፣ ኮሚቴ እና በይፋ የተጋሩ የእውቂያ አማራጮችን ለማየት መሪን ጠቅ ያድርጉ።',
      modalCloseLabel: 'ዝጋ',
    },
    contactLabels: {
      email: 'ኢሜይል',
    ...
    committees: [
      ...
      },
      {
        ...
        title: 'የዳይሬክተሮች ቦርድ',
        description:
          'የECAA ተልዕኮ እና የማህበረሰብ ስራን የሚከታተሉ እና የሚመሩ የአስተዳደር ቦርድ አባላት።',
      },
      {
        id: 'audit-committee',
      ...
      },
      {
        ...
        title: 'አማካሪ ቦርድ',
        description:
          'ECAAን በመመሪያ፣ በእውቀት እና በማህበረሰብ እይታ የሚደግፉ አማካሪ አባላት።',
      },
      {
        id: 'edir-committee',
        ...
        title: 'የኤዲር ኮሚቴ',
        description:
          'በኢሲኤኤ ውስጥ ከኢዲአር ጋር የተያያዘ የማህበረሰብ ድጋፍ እና አስተዳደር ጋር የተያያዘ አመራር።',
      },
    ],
    emptyState: {
...
function mergeCommittees(englishCommittees = [], amharicCommittees = []) {
  const amById = Object.fromEntries(amharicCommittees.map((committee) => [committee.id, committee]))
  return englishCommittees.map((committee) => mergeLocalizedContent(committee, amById[committee.id] || {}))
}
...
export function getLeadershipPageContent(language = 'en', remoteContent = null) {
  ...
  return {
    ...
    explorer: mergeLocalizedContent(mergeLocalizedContent(en.explorer, am.explorer), remoteAm.explorer),
    ...
    finalCta: {
      ...
      buttons: mergeHighlightCards(en.finalCta.buttons, remoteAm.finalCta?.buttons || am.finalCta.buttons),
    },
  }
}
