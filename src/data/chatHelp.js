...
export const CHAT_NO_MATCH_MESSAGE =
  "I can help you find membership, events, programs, hall rental, media, leadership, documents, and contact information.";
...
export const intents = [
  {
    ...
    answer:
      "You can learn about ECAA membership and start the registration process on the Membership page.",
  ...
  },
  {
    id: "volunteer",
    title: "Volunteer",
    keywords: ["volunteer", "help", "serve", "get involved", "civic engagement", "በጎ ፈቃደኝነት"],
    answer:
  ...
  },
  {
    id: "donate",
    title: "Support ECAA",
    keywords: ["donate", "donation", "give", "support", "sponsor", "ድጋፍ", "ልገሳ"],
  ...
  },
  {
    ...
    answer:
      "Learn about ECAA’s mission, history, and how the association serves the Atlanta community.",
  ...
  },
  {
    ...
    answer:
      "Return to the homepage for featured events, programs, media, and ways to get involved.",
