...
export const mediaPageContent = {
  en: {
    ...
    sections: {
      ...
      links: {
        ...
        description: 'Eventbrite, Google Forms, Partiful, documents, and other helpful event links.',
        emptyState: {
  ...
  am: {
    hero: {
      ...
      description:
        'ከECAA ዝግጅቶች እና ፕሮግራሞች ፎቶዎችን፣ በራሪ ወረቀቶችን፣ ቪዲዮዎችን እና የማህበረሰብ አገናኞችን ያስሱ።',
      buttons: [
...
export function getMediaPageContent(language = 'en', remoteContent = null) {
  ...
  return {
    ...
    sections: {
      featured: mergeSection(en.sections.featured, am.sections.featured, remoteAm.sections?.featured),
