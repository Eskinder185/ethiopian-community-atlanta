...
export const programsPageContent = {
  en: {
    hero: {
      ...
      buttons: [
        {
          label: sharedLinks.explorePrograms.label,
          href: sharedLinks.explorePrograms.href,
          style: "primary",
        },
        {
          label: sharedLinks.contactEcaa.label,
          href: sharedLinks.contactEcaa.href,
          style: "secondary",
        },
      ],
    },
    ...
    detailLabels: {
      ...
      overviewFallback:
        "More information about this program will be added as details become available.",
  ...
  am: {
    ...
    detailLabels: {
      ...
      programDetailsIntro: "የፕሮግራሙ ተጨማሪ መረጃ መርሃ ግብሮች፣ ሀብቶች እና የማህበረሰብ አገልግሎቶች ሲጠናቀቁ ይሰፋል።",
