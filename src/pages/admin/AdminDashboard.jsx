  ...
  return (
    <div className="mx-auto max-w-5xl">
      <div className="mb-8">
        ...
        <p className="mt-2 max-w-2xl text-base text-ecaa-ink-muted">{adminT('dashboard.description')}</p>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        {sectionKeys.map((section) => (
          ...
          >
            ...
            <p className="mt-4 text-sm font-semibold text-ecaa-green-800">{adminT('dashboard.openSection')}</p>
          </Link>
        ))}
      </div>
    </div>
