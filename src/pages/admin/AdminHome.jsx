...
export default function AdminHome() {
  ...
  return (
    <div className="mx-auto max-w-4xl">
      <div className="mb-6">
        <h1 className="text-2xl font-semibold tracking-tight text-ecaa-ink">{adminT('home.title')}</h1>
        <p className="mt-1 text-sm text-ecaa-ink-muted">{adminT('home.description')}</p>
      </div>

      <AdminSetupNotice
        message={hasSupabaseConfig() ? '' : adminT('home.supabaseNotice')}
      />
      ...
      <form onSubmit={handleSave} className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            {!isAmEditor && (
              <FormInput
                ...
                onChange={(event) => updateNested('eventsCommunity', 'maxItems', Number(event.target.value))}
              />
            )}
            {isAmEditor ? (
              <CtaLabelField
                ...
                onChange={(field, value) => setCtaField('eventsCommunity', 'sectionCta', field, value)}
              />
            ) : (
              <CtaFields
                ...
                onChange={(field, value) => updateCta('eventsCommunity', 'sectionCta', field, value)}
              />
            )}
            <FormInput
            ...
            <FormTextarea
              ...
              onChange={(event) => setEmptyField('eventsCommunity', 'description', event.target.value)}
            />
            {isAmEditor ? (
              <CtaLabelField
          ...
          <div className="space-y-4">
            ...
            {!isAmEditor && (
              <FormInput
                ...
                type="number"
                value={sections.communityMoments?.maxItems ?? 4}
                onChange={(event) => updateNested('communityMoments', 'maxItems', Number(event.target.value))}
              />
            )}
            {isAmEditor ? (
              <CtaLabelField
                ...
                onChange={(field, value) => setCtaField('communityMoments', 'sectionCta', field, value)}
              />
            ) : (
              <CtaFields
                ...
                onChange={(field, value) => updateCta('communityMoments', 'sectionCta', field, value)}
              />
            )}
            <FormInput
            ...
            <FormTextarea
              ...
              onChange={(event) => setEmptyField('communityMoments', 'description', event.target.value)}
            />
            {isAmEditor ? (
              <CtaLabelField
        ...
        <SectionCard title={adminT('home.bookHall')} description={adminT('home.bookHallDescription')}>
          <div className="space-y-4">
            {!isAmEditor && (
              <ToggleField
                id="book-visible"
            ...
            {isAmEditor ? (
              <>
                ...
                <FormInput
                  ...
                  onChange={(event) => updateNestedAm('bookHall', 'goodForLabel', event.target.value)}
                />
                <FormInput
            ...
            <div>
              <div className="mb-2 flex items-center justify-between gap-3">
                ...
                {!isAmEditor && (
                  <button type="button" onClick={addUseCase} className="text-sm font-semibold text-ecaa-green-800">
                    {adminT('common.addItem')}
                  </button>
                )}
              </div>
              <div className="space-y-2">
                {(isAmEditor ? sectionsAm.bookHall?.useCases : sections.bookHall?.useCases || []).map(
                  (item, index) => (
          ...
          <div className="space-y-4">
            ...
            {!isAmEditor && (
              <FormInput
                ...
                onChange={(event) => updateNested('featuredPrograms', 'maxItems', Number(event.target.value))}
              />
            )}
            {isAmEditor ? (
              <CtaLabelField
                ...
                onChange={(field, value) => setCtaField('featuredPrograms', 'sectionCta', field, value)}
              />
            ) : (
              <CtaFields
                ...
                onChange={(field, value) => updateCta('featuredPrograms', 'sectionCta', field, value)}
              />
            )}
          </div>
        </SectionCard>

        <SectionCard title={adminT('home.finalCta')} description={adminT('home.finalCtaDescription')}>
          <div className="space-y-4">
            {!isAmEditor && (
              <ToggleField
                id="final-visible"
            ...
            />
            {(isAmEditor ? sectionsAm.finalCta?.buttons : sections.finalCta?.buttons || []).map(
              (button, index) =>
                isAmEditor ? (
                  <CtaLabelField
