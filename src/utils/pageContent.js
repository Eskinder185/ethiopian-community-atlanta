...
function warnPageContentFallback(pageKey, context, error) {
  console.warn(`Using fallback ${pageKey} page content because Supabase failed (${context})`, error)
}
...
export async function saveLeadershipPageContent({ content, contentAm }) {
  if (!hasSupabaseConfig()) {
    throw new Error('Supabase is not configured. Leadership page content cannot be saved online yet.')
  }
